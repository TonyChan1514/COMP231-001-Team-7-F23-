...
CREATE TABLE comp231_orderstatus_map (
    orderStatus NUMBER(1) NOT NULL,
    description VARCHAR(20) NOT NULL
);

CREATE TABLE comp231_network_log (
    logSeqID NUMBER NOT NULL,
    access_time TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    access_ip_address VARCHAR2(15),
	CONSTRAINT network_log_logSeqID_PK PRIMARY KEY (logSeqID)
);
...
CREATE SEQUENCE seq_logSeqID START WITH 1 INCREMENT BY 1 NOCACHE NOCYCLE;
